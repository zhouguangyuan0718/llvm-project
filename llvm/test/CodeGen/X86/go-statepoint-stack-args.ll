...
; CHECK: fixedStack:
; CHECK: - { id: 0, type: default, offset: 48, size: 8,
; CHECK: - { id: 1, type: default, offset: 64, size: 8,
; CHECK: - { id: 2, type: default, offset: 48, size: 24,
; CHECK: stack:           []
; CHECK: STATEPOINT 2,
; CHECK-SAME: 2, 2, 1, 8, %fixed-stack.1, 0, 1, 8, %fixed-stack.0, 0,
; CHECK-SAME: (volatile load store (s64) on %fixed-stack.1, align 16),
; CHECK-SAME: (volatile load store (s64) on %fixed-stack.0, align 16)
; CHECK-NEXT: ADJCALLSTACKUP64
