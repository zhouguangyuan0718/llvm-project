...
define preserve_mostcc void @t16(i64 %x) "target-features"="+egpr,+reserve-r16" {
; CHECK-LABEL: t16:
; CHECK: # %bb.0:
...
; CHECK-NEXT:        #NO_APP
; CHECK-NEXT:        ret
  call i64 asm sideeffect "", "={r16},{r16}"(i64 %x)
  ret void
}

define preserve_mostcc void @t31(i64 %x) "target-features"="+egpr,+reserve-r31" {
; CHECK-LABEL: t31:
; CHECK: # %bb.0:
; CHECK-NEXT:        movq    %rdi, %r31
; CHECK-NEXT:        #APP
; CHECK-NEXT:        #NO_APP
; CHECK-NEXT:        ret
  call i64 asm sideeffect "", "={r31},{r31}"(i64 %x)
  ret void
}
