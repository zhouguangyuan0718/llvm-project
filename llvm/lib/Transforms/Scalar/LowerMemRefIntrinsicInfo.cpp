...
bool memref_lowering::isMemRefReduceAddIntrinsic(Intrinsic::ID ID) {
  // Replace the example enum with the actual intrinsic ID generated by the
  // local Intrinsics.td definition.
  //
  // switch (ID) {
